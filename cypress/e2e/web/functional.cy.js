...
describe("Should test at functional level", () =>{
    ...
    it('Should update an account', function ()  {
        cy.accessAccountMenu()
        cy.xpath(locators.ACCOUNTS.FN_XP_BTN_UPDATE(Cypress.env('account_name'))).click()
    ...
    it('Should create a transaction', function() {
        ...
        cy.get(locators.ACCOUNT_TRANSACTION.ACCOUNT).select(Cypress.env('account_name'))
    ...
    it('Should get balance', function() {
        ...
        cy.xpath(locators.BALANCE.FN_XP_ACCOUNT_BALANCE(Cypress.env('account_name'))).should('contain', '123,00')
    })

    it('Should delete a transaction', function() {
        cy.get(locators.MENU.EXTRACT).click()
        cy.xpath(locators.EXTRACT.FN_XP_DELETE_TRANSACTION('Desc')).click()
